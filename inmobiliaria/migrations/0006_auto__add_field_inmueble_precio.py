...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inmueble.precio'
        db.add_column(u'inmobiliaria_inmueble', 'precio',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=200000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inmueble.precio'
        db.delete_column(u'inmobiliaria_inmueble', 'precio')
