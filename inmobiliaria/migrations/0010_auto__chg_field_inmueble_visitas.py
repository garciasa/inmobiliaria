...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inmueble.visitas'
        db.alter_column(u'inmobiliaria_inmueble', 'visitas', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Inmueble.visitas'
        db.alter_column(u'inmobiliaria_inmueble', 'visitas', self.gf('django.db.models.fields.IntegerField')(default=''))
